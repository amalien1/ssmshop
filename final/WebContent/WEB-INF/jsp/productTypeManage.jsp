...
<html>
	...
	function doDelete(id) {
		...
		if(flag){
			//在当前标签页打开超链接
			alert("删除成功！");
			window.location.href="deleteProductType?id="+id;
		}
	}
</script>
	</head>
	...
	<body>
		<div class="container-fluid">
			...
			<div class="div2">
				<!-- 显示商品分页数据 -->
				<div align="right">
					<form action="${pageContext.request.contextPath}/doAddProductType" method="post">
						${addmsg}
						<input type="text" name="typename" placeholder="请输入想添加的商品">
				...
				<table class="table table-bordered table-striped">
					...
					<c:forEach items="${productType}" var="type">
						<tr>
							...
							<td align="center">
							<a href="${pageContext.request.contextPath}/editProductType?id=${type.id}">编辑</a>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="#"  onclick="doDelete(${type.id})">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
